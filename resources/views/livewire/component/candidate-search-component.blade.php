<div class="w-10/12 mx-auto flex flex-col lg:flex-row justify-between">
    ...
    <div class="relative my-6 md:w-60">
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
             ...
             viewBox="0 0 20 20" fill="currentColor" aria-labelledby="title-04 description-04" role="graphics-symbol">
